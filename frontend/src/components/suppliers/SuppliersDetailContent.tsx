...
type SuppliersDetailContentProps = {
  supplierId: number;
};
...
export async function SuppliersDetailContent({
  supplierId,
}: SuppliersDetailContentProps) {
  const [
    supplierResponse,
    accountResponse,
        ...
        {transactions.length === 0 ? (
          <div className="flex min-h-[240px] flex-col items-center justify-center px-6 text-center">
            ...
            <p className="mt-1 max-w-md text-xs leading-5 text-muted-foreground">
              تراکنش‌های خرید، پرداخت و برگشت
              وجه این تأمین‌کننده در این بخش
              نمایش داده می‌شوند.
            </p>
          </div>
        ) : (
