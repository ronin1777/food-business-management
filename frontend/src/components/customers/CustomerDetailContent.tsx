...
export async function CustomerDetailContent({
  ...
  const [
    ...
    getCustomerAccountServer(customerId),
    getCustomerTransactionsServer({
      customer: customerId,
      page: 1,
      pageSize: 10,
  ...
  const direction = account.direction ?? null;
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
            ...
            <p className="mt-2 text-xl font-semibold">
              {formatMoney(Number(account.debit ?? 0))}
            </p>
          </div>
          ...
          <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
            ...
            <p className="mt-2 text-xl font-semibold">
              {formatMoney(Number(account.credit ?? 0))}
            </p>
          </div>
                  ...
                  >
                    ...
                    <td className="px-5 py-4">
                      {transaction.order ? (
                        ...
                        >
                          #{formatNumber(transaction.order)}
                        </Link>
                      ) : (
