...
type SupplierTransactionsErrorProps = {
  error: Error & {
    digest?: string;
  };
  reset: () => void;
...
export default function SupplierTransactionsError({
  error,
  reset,
}: SupplierTransactionsErrorProps) {
  console.error(
    ...
    <div className="flex min-h-[500px] items-center justify-center">
      <div className="w-full max-w-md rounded-xl border border-destructive/20 bg-destructive/5 p-6 text-center">
        ...
        <p className="mt-2 text-sm leading-6 text-muted-foreground">
          در دریافت تراکنش‌های تأمین‌کننده مشکلی
